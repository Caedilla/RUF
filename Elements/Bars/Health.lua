...
function RUF.HealthSettingsChanged(element, unit)
-- When we change health bar settings, copy the db values to the oUF element and force the frame element to update.

-- for example   element.__owner.Health.colorClass == RUF.db.profile.Appearance.Bars.Health.Color.Class
-- element.__owner.Health:ForceUpdate()
end
...
function RUF.SetHealthBar(self, unit)
	...
	Bar.Smooth = true --RUF.db.profile.Appearance.Bars.Health.Animate
